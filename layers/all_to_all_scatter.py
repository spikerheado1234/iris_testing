...
from kernels import counts_exchange_kernel, tokens_exchange_kernel, receiver_wait_kernel #NEW TIMING KERNEL
...
class AllToAllOp(torch.autograd.Function):
    ...
    """
        ...
        # NEW receive wait kernel for timing
        receiver_wait_kernel[(e_local,)](
            token_sync,
            recv_wait_cycles,
            world_size=world_size,
        )
